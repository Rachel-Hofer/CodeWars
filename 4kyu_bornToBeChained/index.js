...
// As you can see, this function receives the methods to be chained and 
// returns an object that allows you to call the chained methods. 
// The result is obtained by calling the execute method.
// Chained functions receive an arbitrary number of arguments. 
// The first function in the chain receives all its arguments. 
// In the other functions, the first argument is the result of the previous 
// function and then it only receives the remainder arguments (second, third, etc.). 
// The tests always pass the appropriate arguments and you do not have to worry about checking this.
